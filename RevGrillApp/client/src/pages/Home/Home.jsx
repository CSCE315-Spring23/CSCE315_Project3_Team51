...
export default function Home() {
    ...
    return (
        <div style={{backgroundColor:"maroon"}}>
            ...
            <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', padding:'0% 10% 0% 5%'}}>
                ...
                <div>
                    ...
                    <h2 style={{fontSize:'100'}} className="description-text">
            ...
            <div style={{display:'flex', backgroundColor:'var(--custom-primary)', gap:'10%', padding:'0% 10% 0%'}}>
                <div>
            ...
            <div>
                ...
                <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', gap:'10px', padding:'0% 25%'}}>
                ...
                <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', gap:'5%', padding:'0% 25%'}}>
                    <div>
